...
function view_products(){
  ...
  $stmt=mysqli_query($conn,$get_products);
  ...
  while($row=mysqli_fetch_array($stmt)){
    ...
    <td>$product_name</td>
     ...
     <td><img src='product_image/$product_image' width='50' heigth='50' /></td>
     <td><a href='view_products.php?edit=$product_id' <button class='btn btn-primary btn-xs fa fa-pencil'></button></a></td>
     <td><a href='view_products.php?delete=$product_id'<button class='btn btn-danger btn-xs fa fa-trash-o'></a></button></td> 
     </tr>";
